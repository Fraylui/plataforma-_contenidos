...
export default async function CategoriesPage() {
  ...
  // Solo categorías con contenido real: una lista de nombres sin portada
  // (las categorías todavía vacías) es justo lo que se pidió sacar de esta
  // página — siguen accesibles por su URL propia, solo no aparecen acá.
    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
      ...
      {withContent.length === 0 ? (
        <p className="mt-10 rounded-lg border border-dashed border-canvas-border px-6 py-16 text-center text-sm text-muted">
          Todavía no hay contenido publicado en ninguna categoría.
        </p>
      ) : (
